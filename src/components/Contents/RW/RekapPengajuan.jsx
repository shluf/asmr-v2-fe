    ...
    <>
      ...
      <Card>
        ...
        <CardContent className="mt-2 space-y-4">
          {isLoadingRekapRW ? (
          ...
          ) : !rekapPengajuanDataRW || rekapPengajuanDataRW.length === 0 ? (
            <Card>
            <CardContent className="p-6">
              <div className="flex flex-col md:flex-row items-start md:items-center gap-4">
            ...
            rekapPengajuanDataRW.map((surat) => (
              <Collapsible
                key={surat.id}
                    ...
                    <div className="flex flex-col md:flex-row items-start md:items-center gap-4">
                      <div className="flex-1 grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-4">
                        ...
                        <div className="flex flex-col h-full justify-between">
                          ...
                          <p className="text-sm flex h-1/2 text-blue-600">{surat.status?.replace("_"," ") || 'N/A'}</p>
                        </div>
                        <div className="flex flex-col h-full justify-between">
                        ...
                        {[
                            ...
                            <label className="flex items-center" key={index}>
                                <TextInput
                                    color="blue"
                                    type="radio"
                                    name={`jenis_surat_rw_rekap_${surat.id}`}
                                    value={jenis}
                  ...
                  <div className="flex gap-2 justify-end items-center w-full mt-4">
                    {surat.approval_surat?.status_approval === 'Ditolak_RT' ? (
                      <PrimaryButton color={'red'} rounded='full'>
                        ...
                        ) : surat.approval_surat?.status_approval === 'Disetujui_RT' || surat.approval_surat?.status_approval === 'Pending_RW' || surat.approval_surat?.status_approval === 'Disetujui_RW' || surat.approval_surat?.status_approval === 'Ditolak_RW' ? (
