      ...
      <Card className="w-full max-w-md mx-auto hover:shadow-lg transition-shadow duration-300">
        ...
        <CardContent className="space-y-4">
          ...
          <div className='flex flex-col justify-center items-center'>
            <div className="flex items-center justify-center md:w-2/3 w-full space-x-2">
              <PhoneCall className="w-5 h-5 text-green-500" />
              <div className='flex items-center'>
                <p className="font-bold text-md w-20">Support</p><span className='mx-1'>:</span>
                <p>0817973xxxx</p>
              </div>
            </div>
          </div>
          <div className="flex justify-center">
            <Button className="w-2/3 md:mt-4" variant="outline" onClick={() => window.location.href = 'tel:0817973xxxx'}>
              Technical Support
            </Button>
          </div>
        </CardContent>
